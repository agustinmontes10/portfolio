...
function ProjectPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="min-h-screen text-gray-700 bg-[#ffffff] flex flex-col justify-between">
