                ...
                <div className="flex">
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex gap-8 mt-10">
                            <a className="flex gap-2 items-center cursor-pointer" href={project.linkGithub} target="_blank">
                            ...
                            <a className="flex gap-2 items-center cursor-pointer" href={project.deployment} target="_blank">
