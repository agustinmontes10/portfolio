        ...
        <>
            ...
            <section className="py-20 px-6 bg-[#00000059]">
                <div className="container mx-auto max-w-[80vw]">
                    ...
                    <div className="w-full flex justify-center">
                        <div className="flex justify-center gap-10 rounded-t bg-[#1e1e1e] pt-2 w-[80%] md:w-[60%]">
                            {['Frontend', 'Backend', 'Others'].map((sec) => (
                                <div
                                    key={sec}
                                    onClick={() => setSection(sec as 'Frontend' | 'Backend' | 'Others')}
                                    className={`px-4 py-2 mx-2 rounded-t cursor-pointer font-semibold ${section === sec ? 'bg-[#080d11]' : ''}`}
                                >
                                    {sec}
                                </div>
                            ))}
                    ...
                    <div className="w-full flex justify-center">
                        <div className="flex gap-10 justify-center p-6 w-[80%] md:w-[60%] border-2 rounded-b border-[#1e1e1e] border-t-0 flex-wrap">
                            {skills[section].map((skill, index) => (
                                <div
                                    key={index}
                                    className="flex flex-col items-center"
                                >
                                    <div className="text-blue-400 mb-4 w-12">{skill.icon}</div>
