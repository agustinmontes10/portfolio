                ...
                <div className="flex flex-col-reverse w-full lg:flex-row gap-10 items-center justify-between">
                    ...
                    >
                        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-2 text-gray-300">{t("contact.lastname")}</label>
                                <CustomInput
                            ...
                            <div className="sm:col-span-2">
                                <label className="block text-sm font-medium mb-2 text-gray-300">{t("contact.message")}</label>
                                <CustomInput
                                    textarea
                    ...
                    >
                        ...
                        <div className="flex gap-6 mb-8">
                            <a
                                ...
                                aria-label="LinkedIn"
                            >
                                <svg viewBox="0 0 128 128" height={36} width={36}>
                            ...
                            <a
                                href="mailto:montesagustin99@gmail.com"
                                className="transition-all duration-200 hover:scale-110 hover:-translate-y-1"
                                aria-label="Email"
                            >
